...
def get_ResultImage(test_x, model, test_predict, BRlocList, img, one_fileGt, dcmfile, savepath, name, predict_boxes, kinds, confidenc_th=0.9):
...
def main(args=None):
    ...
    for i, name in enumerate(testnames):
        ...
        get_ResultImage(test_x, model, test_predict, BRlocList, img, one_fileGt, dcmfile, savepath, name, predict_boxes, kinds, confidenc_th=0.9)
